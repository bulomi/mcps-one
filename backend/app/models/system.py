...
class DatabaseBackup(Base):
    ...
    backup_type = Column(String(20), default="manual", comment="备份类型: manual, auto, scheduled")
    status = Column(String(20), default="completed", comment="备份状态: running, completed, failed")
    ...
    def __repr__(self):
        return f"<DatabaseBackup(filename='{self.filename}', status='{self.status}')>"
